<div class="container mt-5">
    ...
    <form method="post" enctype="multipart/form-data">
        <div class="form-group">
            <input type="hidden" name="MaTruyen" value="<?=$_GET['id']?>">
            <label for="tieuDe">Tiêu Đề:</label>
            <input type="text" class="form-control"  style="width: 100%"value="<?=$truyen->TieuDe ?>" id="tieuDe" name="TieuDe" required>
        </div>

        <div class="form-group">
            <label for="maTacGia">Mã Tác Giả:</label>
            <input type="text" class="form-control"value="<?=$truyen->MaTacGia ?>"  style="width: 100%" id="MaTacGia" name="MaTacGia">
        </div>
        ...
        <!-- <label for="TheLoai">Thể Loại:</label>
            <select class="input-sm" name="TheLoai" id="select-genre"  style="width: 100%">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="moTa"value="<?=$truyen->MoTa ?>" style="width: 100%" name="MoTa" rows="4"></textarea>
        </div>

        <div class="form-group">
            <label for="luotXem">Lượt Xem:</label>
            <input type="number" class="form-control" value="<?=$truyen->LuotXem ?>"  style="width: 100%"id="LuotXem" name="luotXem">
        </div>

        <div class="form-group">
            <label for="luotThich">Lượt Thích:</label>
            <input type="number" class="form-control" value="<?=$truyen->LuotThich ?>"  style="width: 100%"id="LuotThich" name="luotThich">
        </div>

        <div class="form-group">
            <label for="danhGia">Đánh Giá:</label>
            <input type="number" class="form-control" value="<?=$truyen->DanhGia ?>" style="width: 100%" id="DanhGia" name="danhGia">
        </div>

        <div class="form-group">
            <label for="img">Ảnh:</label>
            <img src="img/<?=$truyen->img ?>" alt="Không có ảnh">
