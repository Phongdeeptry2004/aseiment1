...
<tr>
    ...
    <th>Hình ảnh </th>
    <th>
        <a href="<?=ROOT_PATH?>admin/addtruyen">Thêm Truyện</a>
    </th>
</tr>
<?php foreach ($data as $value) : ?>
    <tr>
        ...
        <td><a href="<?=ROOT_PATH?>admin/edittruyen?id=<?=$value->MaTruyen?>">Sửa</a></td>
        <td><a href="<?=ROOT_PATH?>admin/deletetruyen?id=<?=$value->MaTruyen?>"onclick="return confirmDelete()" >Xoá</a></td>
        <td><a href="<?=ROOT_PATH?>admin/chuongtruyen?id=<?=$value->MaTruyen?>">Chi Tiết</a></td>
    </tr>
<?php endforeach ?>
</table>
<script>
